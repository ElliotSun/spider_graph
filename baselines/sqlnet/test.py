...
if __name__ == '__main__':
    ...
    sql_data, table_data, val_sql_data, val_table_data, test_sql_data, test_table_data, schemas, TRAIN_DB, DEV_DB, TEST_DB = load_dataset(args.dataset, use_small=USE_SMALL)

    word_emb = load_word_emb('/Users/chaosun/Documents/NLIDB/dataset/spider_graph/baselines/glove.42B.300d.txt', load_used=args.train_emb, use_small=USE_SMALL)
